...
import { WhatsAppHeaderButton } from "@/components/WhatsAppConnect";
    ...
    >
      <div className="container-wide flex items-center justify-between gap-2 px-4 py-3 sm:px-5 md:px-8 lg:px-12">
        ...
        <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
          ...
          <button
            type="button"
            className="inline-flex min-h-11 min-w-11 items-center justify-center rounded-lg p-2.5 lg:hidden"
